          ...
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow mt-11 max-md:mt-10 max-md:max-w-full">
              <div className="flex flex-col self-start px-5 text-4xl">
                ...
                <div className="mt-3 text-white">Expanding Horizons</div>
              </div>
              <div className="px-2.5 pt-2.5 mt-6 text-xl leading-10 text-blue-600 max-md:mr-2.5 max-md:max-w-full">
              At Spectov, continuous learning is at the heart of our culture. We believe that staying ahead in the tech industry requires constant knowledge acquisition and skill development. Our team members are encouraged to pursue,{" "}
                <span className="font-bold text-blue-600">
                new learning opportunities,{" "}
                </span>
                from formal education and certifications to on-the-job training and knowledge sharing sessions. By fostering a learning environment, we ensure that our team remains at the{" "}
                <span className="font-bold text-blue-600">
                cutting edge of technology
                </span>
                ready to tackle any challenge with fresh perspectives and advanced skills.
              </div>
...
<div className="mt-40 w-full max-w-[1252px] max-md:mt-10 max-md:max-w-full">
<div className="flex gap-5 max-md:flex-col max-md:gap-0">
  <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
    <div className="flex flex-col grow mt-16 max-md:mt-10 max-md:max-w-full">
      ...
      <div className="px-2.5 pt-2.5 mt-6 text-xl leading-10 text-blue-600 max-md:mr-2.5 max-md:max-w-full">
      Growth is the ultimate goal at Spectov, not just for our company, but for our clients and our team members. We aim to foster an environment where everyone can{" "}
        <span className="font-bold text-blue-600">
        thrive and achieve{" "}
        </span>
        their full potential. This means providing ample opportunities for professional development, encouraging career advancement, and supporting personal growth. For our clients, we focus on delivering {" "}
        <span className="font-bold text-blue-600">
        scalable solutions
        </span>
        that enable their businesses to expand and succeed in a competitive market. At Spectov, growth is a shared journey of success and continuous improvement.
      </div>
      <div className="flex flex-col justify-center p-2.5 mt-6 max-md:max-w-full">
        <div className="shrink-0 h-px max-md:max-w-full" />
      </div>
      ...
      {/* <div className="flex flex-col justify-center px-9 py-2.5 mt-6 max-w-full text-xl text-white rounded-3xl border-cyan-400 border-solid border-[0.777px] w-[219px] max-md:px-5">
        <div className="flex gap-4 py-1">
          ...
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/46bc0f6da2dcc4a29f56c7ab6567d5b4272ca61ad8f250bf6e11d47db73c04ee?apiKey=9a257399887b42c7b87198aa88395e96&"
            className="shrink-0 aspect-square w-[19px]"
          />
        </div>
      </div> */}
  ...
  <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
    <img
      loading="lazy"
      srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/869552a2b66a2e396d12cd8816639a08e8f97e3e71842fc065741f6a8d0fde3f?apiKey=9a257399887b42c7b87198aa88395e96&"
      className="w-full aspect-square max-md:mt-10 max-md:max-w-full"
    />
  </div>
</div>
