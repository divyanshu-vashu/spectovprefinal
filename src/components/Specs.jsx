          ...
          <tr className='even'>
            ...
            <td>
              <ul>
                ...
                <li>Refresh rate: Up to 120Hz (2D mode 120 Hz, 3D mode 90Hz)*</li>
                <li>Brightness: Up to 400 nits</li>
                <li>*3D refers to the 3840*1080 stereoscopic mode, while 2D refers to the 1920*1080 monoscopic mode.</li>
              </ul>
            </td>
          </tr>
          <tr>
          ...
          <tr className='even'>
            ...
            <td>
              <ul>
                ...
                <li>iPhone*, Android, MacBook, Steam Deck, ROG Ally, Windows PC and more.</li>
                <li>3DoF: XREAL Beam</li>
                <li>*For models with Lightning connectivity, the use of an XREAL Adapter or Beam is necessary.</li>
              </ul>
            </td>
          </tr>
          <tr>
